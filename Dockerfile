...
RUN mamba install pytorch torchvision torchaudio -c pytorch -y
...
RUN apt-get install -y alsa-base alsa-utils -y
RUN mamba install pyaudio -y
RUN mamba install python-sounddevice -y
